  ...
  $.smallipop = {
    ...
    hideSmallipop: function() {
      ...
      return sip.popup.data({
        ...
        return typeof triggerOpt.onAfterHide === "function" ? triggerOpt.onAfterHide() : void 0;
      });
    },
    ...
    refreshPosition: function() {
      ...
      return popup.data({
        xDistance: xDistance,
        yDistance: yDistance
      }).stop(true).css(cssTarget).animate(animationTarget, options.popupAnimationSpeed, options.funcEase, function() {
        if (beingShown) {
    ...
    _triggerMouseover: function() {
      ...
      if (!popup.data('beingShown') && shownId !== id) {
    ...
    setContent: function(content) {
      var sip;
      sip = $.smallipop;
      sip.popup.find('.sipContent').html(content);
      return sip.refreshPosition();
    }
  };
