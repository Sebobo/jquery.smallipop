  ...
  */
  ...
  return $.fn.smallipop = function(options, hint) {
    ...
    return this.each(function() {
      var newId, objHint, self, triggerOptions, type;
      self = $(this);
      ...
      if (objHint && !self.hasClass('sipInitialized')) {
        ...
        self.addClass("sipInitialized smallipop" + newId).attr('title', '').bind(triggerEvents);
        ...
        if (!triggerOptions.hideOnTriggerClick) {
          return self.delegate('a', 'click.smallipop', sip.hideSmallipop);
        }
      }
    });
  };
