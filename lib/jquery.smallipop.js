...
(function($) {
  ...
  sip = $.smallipop = {
    ...
    _tourShow: function(title, index) {
      var closeButton, content, currentTourItems, nextButton, prevButton, progress, trigger, triggerData;
      ...
      content = "        <div class=\"smallipop-tour-header\">" + triggerData.tourTitle + "</div>        <div class=\"smallipop-tour-content\">" + triggerData.hint + "</div>        <div class=\"smallipop-tour-footer\">          " + progress + "          " + prevButton + "          " + nextButton + "          " + closeButton + "          <br style=\"clear:both\"/>        </div>";
      sip.killTimers();
