...
(function($) {
  ...
  $.smallipop = sip = {
    ...
    _refreshPosition: function() {
      var isFixed, offset, opacity, options, popup, popupCenter, popupData, popupDistanceBottom, popupDistanceLeft, popupDistanceRight, popupDistanceTop, popupH, popupId, popupOffsetLeft, popupOffsetTop, popupW, popupY, preferredPosition, selfHeight, selfWidth, selfY, shownId, trigger, win, winHeight, winScrollTop, winWidth, windowPadding, xDistance, yDistance, yOffset, yOverflow, _ref, _results;
      _ref = sip.instances;
      _results = [];
      for (popupId in _ref) {
        popup = _ref[popupId];
        ...
        if (preferredPosition === 'left' || preferredPosition === 'right') {
          ...
          if ((preferredPosition === 'left' && popupDistanceLeft > windowPadding) || popupDistanceRight < windowPadding) {
