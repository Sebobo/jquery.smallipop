...
(function($) {
  ...
  $.smallipop = sip = {
    ...
    _hideSmallipop: function(e) {
      ...
      if (triggerOptions.cssAnimations.enabled) {
        ...
        if (triggerOptions.onAfterHide) {
          return window.setTimeout(triggerOptions.onAfterHide, triggerOptions.popupAnimationSpeed);
        }
      } else {
    ...
    refreshPosition: function() {
      var animationTarget, beingShown, offset, options, popup, popupCenter, popupDistanceBottom, popupDistanceLeft, popupDistanceRight, popupDistanceTop, popupH, popupOffsetLeft, popupOffsetTop, popupW, popupY, selfHeight, selfWidth, selfY, shownId, trigger, win, winHeight, winWidth, windowPadding, xDistance, yDistance, yOffset;
      popup = sip.popup;
      shownId = popup.data('shown');
      if (!shownId) {
        return;
    ...
    _triggerMouseout: function() {
      var id, popup, popupData, self, shownId, _base, _ref;
      self = $(this);
      id = (_ref = self.data('smallipop')) != null ? _ref.id : void 0;
      popup = sip.popup;
      ...
      if (id) {
        if (typeof (_base = self.data('smallipop').options).onBeforeHide === "function") {
