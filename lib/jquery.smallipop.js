...
(function($) {
  ...
  $.smallipop = sip = {
    ...
    _triggerMouseover: function() {
      var id, isTrigger, popup, self, shownId, triggerData, _base;
      self = popup = $(this);
      ...
      if (self.length && (shownId !== id || popup.css('opacity') === 0)) {
    ...
    _triggerMouseout: function() {
      var id, isTrigger, popup, popupData, self, triggerData, _base;
      self = popup = $(this);
      isTrigger = self.hasClass('sipInitialized');
      id = null;
      triggerData = null;
